...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-primary selection:text-white overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-main-bg pt-24 md:pt-20 pb-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <motion.p 
            ...
            className="font-sans text-base sm:text-lg md:text-xl text-body-text max-w-2xl mx-auto mb-10 md:mb-12 leading-relaxed font-medium px-2"
          >
      ...
      <section id="solucoes" className="py-20 md:py-32 bg-surface relative z-10 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tighter mb-4 text-dark-text">Ecossistema de Soluções</h2>
            <p className="text-body-text text-base md:text-lg font-medium px-4">Pilares estratégicos baseados em dados para escalar sua operação.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {services.map((service, i) => (
              ...
              >
                ...
                <h4 className="text-xl md:text-2xl font-extrabold font-display text-dark-text mb-3">{service.title}</h4>
                <p className="text-body-text text-sm md:text-base leading-relaxed font-medium">{service.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 h-auto md:h-[600px]">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="md:col-span-2 modern-card rounded-[2rem] p-6 md:p-8 flex flex-col justify-between group overflow-hidden relative min-h-[350px] md:min-h-0"
            >
              <div className="relative z-10 mb-8 md:mb-12">
                ...
                <p className="text-body-text text-sm max-w-md font-medium">O foco central de nossa operação não são métricas de vaidade, mas sim a criação de esteiras de vendas contínuas. Aumentamos a previsibilidade do seu caixa.</p>
              </div>
            ...
            <motion.div 
              ...
              className="modern-card rounded-[2rem] p-6 md:p-8 flex flex-col justify-start group relative overflow-hidden"
            >
            ...
            <motion.div 
              ...
              className="md:col-span-2 modern-card rounded-[2rem] p-6 md:p-8 flex items-center justify-between group overflow-hidden relative"
            >
              <div className="relative z-10 max-w-md w-full md:w-auto">
      ...
      <section id="sobre" class="py-20 md:py-32 relative z-10 bg-main-bg overflow-hidden border-t border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-16">
            ...
            >
              <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tighter mb-4 text-dark-text">A mente estratégica por trás da <span className="text-primary">AXIS.</span></h2>
              ...
              <div className="space-y-4 md:space-y-5 text-body-text font-medium text-base md:text-lg leading-relaxed mb-8 md:mb-10 text-left">
              ...
              <blockquote className="pl-4 md:pl-6 py-2 quote-border bg-linear-to-r from-primary/5 to-transparent italic text-dark-text text-lg md:text-2xl font-display font-semibold mb-8 md:mb-10 leading-snug text-left">
      ...
      <section id="publico" className="py-20 md:py-32 relative z-10 bg-surface">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-16">
            ...
            >
              <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tighter mb-4 md:mb-6 text-dark-text text-center md:text-left">Projetado para <span className="text-primary">negócios sérios.</span></h2>
              <p className="text-body-text text-base md:text-lg mb-8 leading-relaxed font-medium text-center md:text-left">Não atendemos qualquer projeto. Nossa estrutura de alta performance requer parceiros que estejam preparados para receber um fluxo constante de novos clientes e alavancar vendas.</p>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <span className="w-2 h-2 mt-1.5 md:mt-2 rounded-full bg-primary mr-3 md:mr-4 flex-shrink-0"></span>
                    <div>
                      <h5 className="font-extrabold text-dark-text text-base md:text-lg">{item.title}</h5>
                      <p className="text-sm text-body-text mt-1 font-medium">{item.desc}</p>
                    </div>
                  </li>
                ))}
              </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((t, i) => (
              ...
              >
                <div className="text-primary flex gap-1 mb-4 md:mb-6 text-lg md:text-xl">
                  ★★★★★
                </div>
                <p className="text-body-text text-sm italic leading-relaxed mb-6 font-medium">"{t.text}"</p>
